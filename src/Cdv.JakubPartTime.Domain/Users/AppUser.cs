...
namespace Cdv.JakubPartTime.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update JakubPartTimeDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update JakubPartTimeEfCoreEntityExtensionMappings to extend the IdentityUser entity
